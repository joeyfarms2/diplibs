<?php
	...
	// General
	$moxieManagerConfig['general.license'] = 'STYO-XEU2-7TAZ-3MIF-5ADP-SMAU-T3QZ-2NA4';
	...
	$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,docx,doc,zip,pdf,mov,mp3,mp4,mpeg,mpg,flv,wma';
	...
	// $mcImageManagerConfig['authenticator.login_page'] = 'http://'.$_SERVER["SERVER_NAME"].'/login'; // <- URL to your login page if the user couldn't be verified
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "nunui_nirat@hotmail.com", "password" => "iq2rdx", "groups" => array("administrator"))
	);
