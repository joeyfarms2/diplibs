...
$master_product_main_menu = @$master_product_main_menu;
...
<aside>
	<div id="sidebar"  class="nav-collapse ">
		...
		<ul class="sidebar-menu" id="nav-accordion">
			...
			<?php } ?>
			<?php
//				if(is_var_array($master_product_main)){ #Modified By Anon@20/04/2017
				if(is_var_array($master_product_main_menu)){
					foreach ($master_product_main_menu as $item) {
