...
<script type="text/javascript" src="<?=JS_PATH?><?=folderName?>/book_copy.js"></script>
<form id="frm_product" name="frm_product" method="POST" action="<?=site_url('admin/product/book-copy/save')?>" class="cmxform form-horizontal tasi-form" enctype="multipart/form-data">
		...
		<div class="col-md-12">
			<section class="panel">
				...
				?>
						<div class="form-group">
							...
							<div class="col-md-12 col-lg-2">
								<input class="form-control" type="text" id="no_4" name="no_4" value="<?=get_array_value($copy_item_detail,"no_4","")?>"/>
					...
					<?php 	
						...
						if($product_main_aid == "1" || $product_main_aid == "2" || $product_main_aid == "7" || $product_main_aid == "8"){
					 ?>
					<div class="form-group">
				...
				?>
						...
						<div class="form-group">
							...
							<div class="col-md-12 col-lg-8">
								...
								<label class="radio-inline">
									<input type="radio" name="use_digital_gen" id="file_upload_digital_gen" value="0" checked onclick="check_file_uploads_limit();" />PDF
								</label>

								<label class="radio-inline">
									<input type="radio" name="use_digital_gen" id="file_upload_default" value="1" <?php if($use_digital_gen == 1) echo 'checked="checked"';?> onclick="check_file_uploads_limit();" />Word , Excel , PowerPoint
								</label>
							</div>
					...
					<div class="form-group hide" id="file_upload_limit_for_default">
						<label class="col-md-12 col-lg-2 control-label required" for="file_upload_doc">File type</label>
						<div class="col-md-12 col-lg-8">
							<input class="spaceUp default" type="file" id="file_upload_doc" name="file_upload_doc"/>
							<p class="help-block" >Only file extension <?=get_file_type(CONST_ALLOW_FILE_TYPE_DEFAULT)?> and size not over <?=get_size(CONST_ALLOW_FILE_SIZE_DEFAULT)?>.</p>
						</div>
						<?php
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-12 col-lg-8">
							...
							?>
								<label class="radio-inline">
									<input type="radio" name="type_minor" id="type_minor_3" value="3" checked />Book
								</label>
								<label class="radio-inline">
									<input type="radio" name="type_minor" id="type_minor_4" value="4" <?php if($type_minor == "4") echo 'checked="checked"';?> />Magazine
								</label>
								<label class="radio-inline">
					...
					<div class="form-group hide">
						<div class="col-md-12 col-lg-offset-2 col-lg-8">
							<label class="checkbox-inline">
								<input type="checkbox" id="update_copies" name="update_copies" value="1" <?php if(get_array_value($copy_item_detail,"update_copies","") == "1") echo 'checked="checked"';?> />Update all this value to every copies of this book
							</label>
						</div>
					</div>
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<a class="btn btn-default" onclick="processRedirect('admin/product-<?=$product_main_url?>/book/edit/<?=$parent_aid?>/copy');" />Cancel</a>
				</div>
				<!-- End : Button -->
			</section>
		</div>
