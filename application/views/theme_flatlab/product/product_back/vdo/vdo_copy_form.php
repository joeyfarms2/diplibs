...
<form id="frm_product" name="frm_product" method="POST" action="<?=site_url('admin/product/vdo-copy/save')?>" class="cmxform form-horizontal tasi-form" enctype="multipart/form-data">
		...
		<div class="col-md-12">
				...
				<div class="panel-body">
							...
							<div class="col-md-12 col-lg-8">
								<div class="checkbox">
									<label>
										...
										This vdo use license from Bookdose
									</label>
								</div>
							</div>
						</div>
					...
					<div class="form-group hide" id="option_digital_area">
						<div class="">
							...
							<div class="col-md-12 col-lg-8">
								<input class="form-control" type="text" id="digital_price" name="digital_price" value="<?=get_array_value($copy_item_detail,"digital_price","")?>" onkeypress="isNumeric(event, this.value)" />
							</div>
						</div>
						...
						<div class="spaceUp">
							...
							<div class="col-md-12 col-lg-8">
								<input class="form-control" type="text" id="digital_point" name="digital_point" value="<?=get_array_value($copy_item_detail,"digital_point","")?>" onkeypress="isNumeric(event, this.value)" />
							</div>
						</div>
					</div>
					...
					<div class="hide" id="option_paper_area">
						<div class="form-group">
							<div class="">
								...
								<div class="col-md-12 col-lg-8">
									<input class="form-control" type="text" id="paper_price" name="paper_price" value="<?=get_array_value($copy_item_detail,"paper_price","")?>" onkeypress="isNumeric(event, this.value)" />
								</div>
							</div>
							...
							<div class="spaceUp">
								...
								<div class="col-md-12 col-lg-8">
									<input class="form-control" type="text" id="paper_point" name="paper_point" value="<?=get_array_value($copy_item_detail,"paper_point","")?>" onkeypress="isNumeric(event, this.value)" />
								</div>
							</div>
							...
							<div class="spaceUp">
								...
								<div class="col-md-12 col-lg-8">
									<input class="form-control" type="text" id="in_stock" name="in_stock" value="<?=get_array_value($copy_item_detail,"in_stock","")?>" onkeypress="isNumeric(event, this.value)" />
								</div>
							</div>
						</div>
					...
					<div class="form-group hide">
						<div class="col-md-12 col-lg-offset-2 col-lg-8">
							<label class="checkbox-inline">
								<input type="checkbox" id="update_copies" name="update_copies" value="1" <?php if(get_array_value($copy_item_detail,"update_copies","") == "1") echo 'checked="checked"';?> />Update all this value to every copies of this vdo
							</label>
						</div>
					</div>
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<a class="btn btn-default" onclick="processRedirect('admin/product-<?=$product_main_url?>/vdo/edit/<?=$parent_aid?>/copy');" />Cancel</a>
				</div>
				<!-- End : Button -->
			</section>
		</div>
