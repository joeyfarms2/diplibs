			...
			<section class="panel">
				...
				<div class="panel-body">
					<div class="col-xs-12 no-left-padding">
						<a href="<?=site_url('admin/product-'.$product_main_url.'/vdo/edit/'.$parent_aid.'/gallerys/add')?>" class="btn btn-primary">
							<i class="fa fa-plus"></i> Add photo gallerys
						</a>
					</div>
					<br>
					<small><em>* All photos in the gallery will be displayed after info.</em></small>
