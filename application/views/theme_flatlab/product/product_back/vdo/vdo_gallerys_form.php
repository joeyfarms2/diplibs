...
<script type="text/javascript" src="<?=JS_PATH?><?=folderName?>/vdo_gallerys.js"></script>
<form id="frm_product" name="frm_product" method="POST" action="<?=site_url('admin/product/vdo-gallerys/save')?>" class="cmxform form-horizontal tasi-form" enctype="multipart/form-data">
		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group hide">
						...
						<div class="col-md-12 col-lg-8">
							<textarea class="form-control" id="description" name="description"><?=get_array_value($gallery_item_detail,"description","")?></textarea>
						</div>
					</div>
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<a class="btn btn-default" onclick="processRedirect('admin/product-<?=$product_main_url?>/vdo/edit/<?=$parent_aid?>/gallerys');" /><i class="fa fa-chevron-left"></i> Back to photo gallerys</a>
				</div>
				<!-- End : Button -->
			</section>
		</div>
