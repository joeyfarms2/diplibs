...
if($init_adv_search != "clear"){
	...
	$data_search = $dataSearchSession->userdata('questionaireCategoryBackDataSearchSession'); 
}
...
<input type="hidden" id="search_order_by" name="search_order_by" value="<?=$search_order_by?>" />
	<div class="row">
		<div class="col-xs-12 m-bot15">
			<a href="<?=site_url('admin/questionaire-category/add')?>" class="btn btn-primary">
				...
				<div id="adv-area" class="panel-body" style="display: none;">
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-8">
							...
							<a class="btn btn-default" onclick="ajaxClearSearchResult('questionaireCategoryBackDataSearchSession')" />Clear</a>
						</div>
					</div>
					<!-- End : Button -->
				</div>
