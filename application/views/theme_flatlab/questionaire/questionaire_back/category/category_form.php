...
<form id="frm_category" name="frm_category" method="POST" action="<?=site_url('admin/questionaire-category/save')?>" class="cmxform form-horizontal tasi-form">
		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-12 col-lg-8">
							<input class="form-control" type="text" id="url" name="url" value="<?=get_array_value($item_detail,"url","")?>" onkeypress="isKeyUrl(questionaire, this.value)" maxlength="100" />
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<a class="btn btn-default" onclick="processRedirect('admin/questionaire-category/show');" />Cancel</a>
				</div>
				<!-- End : Button -->
			</section>
		</div>
