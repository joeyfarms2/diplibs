...
<head>
    ...
    <link type="text/css" rel="stylesheet"
          href="<?= CSS_PATH ?><?= CONST_CODENAME ?>/css/fullcalendar/fullcalendar.min.css">
    <link type="text/css" rel="stylesheet"
          href="<?= CSS_PATH ?><?= CONST_CODENAME ?>/css/fullcalendar/fullcalendar.print.css" media='print'>
...
<script type="text/javascript"
        src="<?= CSS_PATH ?><?= CONST_CODENAME ?>/js-plugin/fullcalendar/fullcalendar.js"></script>
