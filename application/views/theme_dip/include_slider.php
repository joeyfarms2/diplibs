...
<!--                    <div class="cover-banner"></div>-->
                    <a href="<?=$ref_link?>"><img src="<?=$img_src?>" class="mySlides slide-animation" style="<?php if($i>0){echo "display:none;";}?>" /></a></div>
			<?php }else{ ?>
				<div class="w3-display-content">
                    <div class="cover-banner"></div>
                    <img class="mySlides slide-animation" src="<?=$img_src?>" style="<?php if($i>0){echo "display:none;";}?>" /></div>
			<?php } ?>
		<?php } ?>
	<?php $i++; } ?>
<?php } ?>
