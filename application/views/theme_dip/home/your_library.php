		...
		<div class="mt10 mb10">
			...
			<?php if(CONST_FRONT_NEWS_MENU=='1'){ ?>
				<div class="col-xs-6 col-sm-4 mb20">
					<a href="<?=site_url('news')?>">
						...
						<img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/your-library3/menu_news_button.png" />
					</a>
				</div>
				...
				<?php if(CONST_FRONT_BOOK_MENU=='1'){ ?>
					<div class="col-xs-6 col-sm-4 mb20">
						<a href="<?=site_url('list-book/category/books')?>">
							<img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/your-library3/menu_e_book_button.png" />
						</a>
					</div>
				<?php } ?>
			...
			<?php if(CONST_FRONT_EMAGAZINE_MENU=='1'){ ?>
				<div class="col-xs-6 col-sm-4 mb20">
					...
					<img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/your-library3/menu_e_magazine_button.png" />
					</a>
				</div>
			<?php } ?>
			<?php if(CONST_FRONT_INFROMATION_MENU=='1'){ ?>
					<div class="col-xs-6 col-sm-4 mb20">
						<a href="<?=site_url('list-book/category/information')?>">
							<img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/your-library3/menu_information_button.png" />
						</a>
					</div>
				<?php } ?>
			<?php if(CONST_FRONT_GALLERY_MENU=='1'){ ?>
					<div class="col-xs-6 col-sm-4 mb20">
						<a href="<?=site_url('list-vdo/category/photo-gallerys')?>">
							<img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/your-library3/menu_gallery_button.png" />
						</a>
					</div>
			<?php } ?>
			<?php if(CONST_FRONT_MUTIMEDIA_MENU=='1'){ ?>
					<div class="col-xs-6 col-sm-4 mb20">
						<a href="<?=site_url('list-vdo/category/multimedia')?>">
							<img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/your-library3/menu_multimedia_button.jpg" />
						</a>
					</div>
			<?php } ?>
