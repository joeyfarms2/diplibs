...
.shelf-under-book-small
{
	...
	height: 39px;
	margin-top: -35px;
	background-image: url(/styles/dip/images/background/bg-shelf-item-red.png);
	background-repeat: no-repeat;
	z-index: -100;
}
...
<?php }else{ ?>
			...
			<div class="row hidden-xs">
				...
				<div class="col-md-12">
					<img class="shelf-under-book-big" src="/styles/<?=CONST_CODENAME?>/images/background/bg-shelf-item-red.png">
				</div>
				<div class="col-sm-3">
			...
			<div class="row visible-xs">
				...
				<div style="clear: both;"></div>
				<div class="col-md-12">
					<img class="shelf-under-book" src="/styles/<?=CONST_CODENAME?>/images/background/bg-shelf-item-red.png">
				</div>
				<div class="col-xs-6">
					<?=draw_item(get_array_value($result_list,"2",""), $optional, $show_option, $sort_by);?>
				</div>
