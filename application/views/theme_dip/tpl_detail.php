...
<head>
    ...
    <meta property="og:image"
          content="<?= get_image(get_array_value($item_result, "cover_image_detail_path", ""), "detail", get_array_value($item_result, "large_image", "")) ?>"/>
    <meta property="og:description"
          content='<?= removeSingleQuote(get_array_value(@$item_result, "description", "")) ?>'/>
