<?php
	...
	if(is_var_array($biblio_field_result)){
		foreach ($biblio_field_result as $field) { 
			...
			if($tag == "260"){
				if($subfield_cd == "b"){
					$field_data_publisher = get_array_value($field,"field_data","");
				
				}
				if($subfield_cd == "c"){
					$field_data_year = get_array_value($field,"field_data","");
					...
					<div class="row mb30">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p class="spaceUp">
								...
								<div class="col-xs-7 col-sm-10 col-md-8 col-lg-4 no-left-padding no-right-padding">
									: <?=get_datetime_pattern(CONST_DEFAULT_DATE_PATTERN, get_array_value($item_result,"expired_date",""), "-")?>
								</div>
								<div class="col-xs-5 col-sm-2 col-md-4 col-lg-2 no-left-padding no-right-padding">
							...
							<p class="spaceUp">
								...
								<div class="col-xs-5 col-sm-2 col-md-4 col-lg-2 no-left-padding no-right-padding">
									<span class="product-sub-title">Published<? //=$publish_date_title?></span>
								</div>
								<div class="col-xs-7 col-sm-10 col-md-8 col-lg-4 no-left-padding no-right-padding">
									: <?=$field_data_year?><? //=get_datetime_pattern(CONST_DEFAULT_DATE_PATTERN, get_array_value($item_result,"publish_date",""), "-")?>
								</div>
								<div class="col-xs-5 col-sm-2 col-md-4 col-lg-2 no-left-padding no-right-padding">
									<span class="product-sub-title">Publisher</span>
								</div>
		...
		<section id="marc">
			<section id="content" class="mt30 pb30">
				<div class="container">
					<div class="row mb30">
						<div class="col-lg-12">
							<div class="review-title button-orage" onclick="toggleMarc()">
