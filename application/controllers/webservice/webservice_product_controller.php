...
class Webservice_product_controller extends Init_webservice_controller
{
    ...
    function get_product_list()
    {
        ...
        if (!is_blank($order_by)) {
            ...
            switch ($order_by) {
                case "match" :
                    $this->view_all_products_2->set_order_by("tag_weight ASC, weight asc, publish_date desc");
                    break;
                case "publish_date_asc" :
                    $this->view_all_products_2->set_order_by("publish_date asc, weight asc");
                    break;
                case "publish_date_desc" :
                    $this->view_all_products_2->set_order_by("publish_date desc, weight asc");
                    break;
                case "total_download_desc" :
                    $this->view_all_products_2->set_order_by("total_download desc, weight asc, publish_date desc");
                    break;
                case "total_download_asc" :
                    $this->view_all_products_2->set_order_by("total_download asc, weight asc, publish_date desc");
                    break;
                case "total_view_desc" :
                    $this->view_all_products_2->set_order_by("total_view desc, weight asc, publish_date desc");
                    break;
                case "total_view_asc" :
                    $this->view_all_products_2->set_order_by("total_view asc, weight asc, publish_date desc");
                    break;
                case "total_read_desc" :
                    $this->view_all_products_2->set_order_by("total_read desc, weight asc, publish_date desc");
                    break;
                case "total_read_asc" :
                    $this->view_all_products_2->set_order_by("total_read asc, weight asc, publish_date desc");
                    break;
                case "title_desc" :
                    $this->view_all_products_2->set_order_by("title desc, weight asc, publish_date desc");
                    break;
                case "title_asc" :
                    $this->view_all_products_2->set_order_by("title asc, weight asc, publish_date desc");
                    break;
                case "author_desc" :
                    $this->view_all_products_2->set_order_by("author desc, weight asc, publish_date desc");
                    break;
                case "author_asc" :
                    $this->view_all_products_2->set_order_by("author asc, weight asc, publish_date desc");
                    break;
                case "popular" :
                    $this->view_all_products_2->set_order_by("weight asc, total_download desc");
                    break;
                case "new" :
        ...
        if (!is_blank($order_by)) {
            ...
            switch ($order_by) {
                ...
                case "popular" :
                    ...
                    $this->view_all_products_2->set_order_by("is_home DESC, weight asc, total_download desc, aid desc");
                    break;
                case "new" :
                    // $this->view_all_products_2->set_where(array("is_new"=>"1"));
