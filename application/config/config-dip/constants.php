...
define('CONST_CODENAME',CONST_PROJECT_CODE);
...
define('CONST_LDAP_LOGIN', '0'); // 0: Login using our system ,1: Login LDAP server, 2: Login LDAP server soap
...
define('CONST_LDAP_BASE_DN', ''); // e.g. DC=scbcorp,DC=co,DC=th
define('CONST_LDAP_ACCOUNT_SUFFIX', ''); // e.g. @scbcorp.co.th
define('CONST_LDAP_DOMAIN_CONTROLLER', ''); // e.g. scbcorp.co.th
...
|--------------------------------------------------------------------------
*/
define('CONST_LDAP_AUTHEN_SOAP', FALSE); // TRUE: Login using LDAP server, FALSE: Login using our system
...
/** Editable Zone **/
define('DEFAULT_TITLE', 'กรมทรัพย์สินทางปัญญา กระทรวงพาณิชย์'); // This value will show in title bar of web browser
...
define('THEME_FRONT_PATH', PUBLIC_PATH.'styles/'.CONST_CODENAME.'/');
define('THEME_ADMIN_PATH', PUBLIC_PATH.'styles/flatlab/');

define('THEME_ADMIN', '_flatlab');
define('THEME_FRONT', '_'.CONST_CODENAME);
define('THEME_LOGIN', '_'.CONST_CODENAME);
...
define('CONST_TITLE_SHORT_CHAR','35');
...
|--------------------------------------------------------------------------
*/
define('CONST_HAS_EVENT','1'); // 1:Use event system, 0:DONT use event system, default is 0
...
|--------------------------------------------------------------------------
*/
define('CONST_HAS_QUESTIONAIRE','1'); // 1:Use questionaire system, 0:DONT use questionaire system, default is 0
...
define('CONST_FRONT_EBOOK_MENU','1');//1:Show 0:Hide
define('CONST_FRONT_MAGAZINE_MENU','1');//1:Show 0:Hide
define('CONST_FRONT_EMAGAZINE_MENU','1');//1:Show 0:Hide
define('CONST_FRONT_INFROMATION_MENU','1');//1:Show 0:Hide
define('CONST_FRONT_MUTIMEDIA_MENU','1');//1:Show 0:Hide
define('CONST_FRONT_CDDVD_MENU','0');//1:Show 0:Hide
define('CONST_FRONT_KNOWLEDGE_MENU','1');//1:Show 0:Hide
define('CONST_FRONT_QUESTIONNAIRE_MENU','1');//1:Show 0:Hide
define('CONST_FRONT_NEWS_MENU','1');//1:Show 0:Hide
define('CONST_FRONT_GALLERY_MENU','1');//1:Show 0:Hide
