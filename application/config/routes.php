...
/*Gallery*/
$route['admin/product-(:any)/vdo/edit/(:num)/gallerys'] = "product/product_vdo_gallerys_back_controller/show/$1/$2";
$route['admin/product-(:any)/vdo/edit/(:num)/gallerys/add'] = "product/product_vdo_gallerys_back_controller/add/$1/$2";
$route['admin/product-(:any)/vdo/edit/(:num)/gallerys/edit/(:num)'] = "product/product_vdo_gallerys_back_controller/edit/$1/$2/$3";
$route['admin/product-(:any)/vdo/edit/(:num)/gallerys/status'] = "product/product_vdo_gallerys_back_controller/status/$1/$2";
$route['admin/product-(:any)/vdo/edit/(:num)/gallerys/status/(:any)'] = "product/product_vdo_gallerys_back_controller/status/$1/$2/$3";
$route['admin/product/vdo-gallerys/ajax-set-value/(:any)'] = "product/product_vdo_gallerys_back_controller/ajax_set_value/$1";
$route['admin/product/vdo-gallerys/ajax-get-main-list/(:any)'] = "product/product_vdo_gallerys_back_controller/ajax_get_main_list/$1";
$route['admin/product/vdo-gallerys/save'] = "product/product_vdo_gallerys_back_controller/save";
$route['admin/product/vdo-gallerys/ajax-delete-one/(:any)'] = "product/product_vdo_gallerys_back_controller/ajax_delete_one/$1";
